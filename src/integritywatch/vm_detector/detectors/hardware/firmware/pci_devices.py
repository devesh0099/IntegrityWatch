...
from integritywatch.utils.platform.base import is_linux, is_windows
...
class PCIDetector(BaseDetector):
    ...
    def _check_linux(self) -> TechniqueResult:
        from integritywatch.utils.platform.linux import get_pci_device_ids
    ...
    def _check_windows(self) -> TechniqueResult:
        from integritywatch.utils.platform.windows import get_pci_device_ids
