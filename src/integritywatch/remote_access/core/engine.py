...
from integritywatch.remote_access.core.result import DetectionResult, TechniqueResult, VERDICT_BLOCK, VERDICT_FLAG, VERDICT_CLEAN
from integritywatch.remote_access.detectors.base import BaseDetector
